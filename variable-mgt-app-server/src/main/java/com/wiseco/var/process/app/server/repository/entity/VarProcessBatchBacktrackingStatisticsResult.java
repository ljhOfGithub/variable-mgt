...
@TableName("var_process_batch_backtracking_statistics_result")
public class VarProcessBatchBacktrackingStatisticsResult extends BaseEntity {
     ...
     * 统计分析ID
     */
    @TableField("backtracking_config_id")
