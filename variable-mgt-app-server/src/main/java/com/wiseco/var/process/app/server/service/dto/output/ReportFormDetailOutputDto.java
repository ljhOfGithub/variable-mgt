...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "监控报表的详情(业务逻辑层)")
public class ReportFormDetailOutputDto implements Serializable {

    private static final long serialVersionUID = 819541174341180471L;
