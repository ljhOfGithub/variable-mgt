...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "报表管理的搜索入参(控制层)")
public class ReportFormSearchInputVo extends PageDTO implements Serializable {

    private static final long serialVersionUID = 5298494632591467900L;
