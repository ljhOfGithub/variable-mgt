...
@Data
@Builder
public class TemplateStaticGetProviderInputDto implements Serializable {
    ...
    @Schema(description = "provider名称", required = true, example = "")
    private List<String> providerNames;

    @Schema(description = "dataValue", required = true, example = "")
    private List<String> dataValues;

    @Schema(description = "为true时只返回公共方法，不返回变量模板; 且分支变量可选范围只有基本信息中已经绑定的数据模型和变量", example = "true")
