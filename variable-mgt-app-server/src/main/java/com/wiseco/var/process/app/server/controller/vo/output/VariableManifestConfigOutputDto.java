...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "变量清单配置输出参数")
public class VariableManifestConfigOutputDto implements Serializable {

    private static final long serialVersionUID = -7917995860842618791L;
