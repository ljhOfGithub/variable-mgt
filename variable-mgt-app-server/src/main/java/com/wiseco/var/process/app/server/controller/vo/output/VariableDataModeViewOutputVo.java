...
public class VariableDataModeViewOutputVo implements Serializable {
    ...
    @Schema(description = "数据模型中content转换为树返回", example = "null")
    private DomainDataModelTreeDto domainDataModelTreeDto;
    ...
    public static class DataModelInsideDataVO implements Serializable {
        ...
        @Schema(description = "内部数据获取方式，获取方式,可用值:TABLE,SQL,示例值(null)")
        @NotBlank(message = "内部数据来源")
        ...
        @Schema(description = "table返回数据", example = "null")
