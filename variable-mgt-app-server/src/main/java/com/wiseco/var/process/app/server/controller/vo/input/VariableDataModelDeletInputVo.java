 ...
 */
@Data
@Schema(description = "数据模型升级版本输入参数")
public class VariableDataModelDeletInputVo implements Serializable {
    ...
    @Schema(description = "对象来源", example = "INSIDE_DATA")
    @NotBlank(message = "对象开源不能为空")
