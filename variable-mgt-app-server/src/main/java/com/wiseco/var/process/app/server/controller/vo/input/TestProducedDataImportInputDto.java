 ...
 * @since 2022/2/14
 */
@Schema(description = "生产数据导入保存参数 DTO")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class TestProducedDataImportInputDto implements Serializable {

    private static final long serialVersionUID = 1743015330820995833L;
    ...
    @Schema(description = "导入行数", example = "1")
