...
/**
 * 指标查询Dto(用于单指标分析和指标对比分析报表选择监控对象, 属于公共服务的一个实体类)
 */

@Data
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "指标查询Dto(用于单指标分析和指标对比分析报表选择监控对象, 属于公共服务的一个实体类)")
public class SingleVariableQueryInputDto implements Serializable {

    private static final long serialVersionUID = -4741128149809666635L;
    ...
    @Schema(description = "标签的Id, 可以为空", example = "20000")
