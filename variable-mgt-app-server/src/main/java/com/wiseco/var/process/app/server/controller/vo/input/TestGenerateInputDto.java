...
@Data
@Builder
public class TestGenerateInputDto implements Serializable {
    ...
    @Schema(description = "生成记录数", example = "1000")
    private Integer generateNums;

    @Schema(description = "样例数据集 UUID")
    private String sampleDataSetUuid;
}
